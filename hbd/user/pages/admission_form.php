...
?>
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">
              <i class="material-icons-round opacity-10">description</i> | Admission Form
            </h6><br>
          </nav>
 ...
 -->Your Admission Form Is Uploaded Succesfully
                </h6>
              </div> <br><br>
                              ...
                              <div class="row">
                                ...
                                <div class="row g-4">
                                  ...
                                  <div class="col-12 col-md-6">
                                    <fieldset>
                                      <b>1 | ID Proof</b><br>
                                      <small><b>NOTE:</b> Upload Aadhar Card, PAN Card, Voting Card, etc.</small>
                                      <div class="mt-2">
                                        <input
                                          class="form-control"
                                          id="tcimage"
                                  ...
                                  <!-- Senior Secondary Marksheet Upload -->
                                  <div class="col-12 col-md-6">
                                    <fieldset>
                                      <b>4 | Senior Secondary Marksheet</b>
                                      <div class="mt-2">
                                        <input
                                          class="form-control"
                                          id="sscimage"
