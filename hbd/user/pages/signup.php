...
if (isset($_POST['submit'])) {
  ...
  if ($result > 0) {
    ...
    echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    text: 'This email or contact number is already associated with another account.',
                    icon: 'error',
    ...
    $query = mysqli_query($con, "insert into tbluser(FirstName, LastName, MobileNumber, Email, Password, applicationid) 
                                     values('$fname', '$lname', '$contno', '$email', '$password', '$applicationid')");
      ...
      echo "<script>
                document.addEventListener('DOMContentLoaded', function() {
                    Swal.fire({
                        ...
                        text: 'You have successfully registered. Your application ID is: $applicationid',
                        icon: 'success',
    ...
    function checkpass() {
      ...
      if (!password.match(passwordRegex)) {
        Swal.fire({
          ...
          text: 'Password must contain at least one uppercase letter, one lowercase letter, one special character, and be at least 8 characters long.',
          icon: 'warning',
      ...
      if (password !== repeatPassword) {
        Swal.fire({
          ...
          text: 'Password and Repeat Password fields must match.',
          icon: 'error',
          confirmButtonText: 'OK'
        });
        ...
        <nav class="navbar navbar-expand-lg blur border-radius-xl top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
          <div class="container-fluid ps-2 pe-0">
            ...
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="">
              <h3>
                <b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; "Make Your SKY Boundriesless....."</b>
              </h3>
            </a>
