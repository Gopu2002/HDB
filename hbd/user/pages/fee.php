...
?>
 ...
 --> <span class="ms-1 font-weight-bold text-white">
            <font face="Comic sans MS" size="4">Hello Dreamy Birds</font>
          </span>
        </a>
      </div>
            ...
            <div class="card-body" id="exampl">
              ...
              ?>
                    ...
                    <table class="table mb-0">
                      <tr>
                        <th>Thank you For Support..</th>
                        <td> <img src="logo/0.0.png" class="navbar-brand-img h-100" alt="main_logo" height="350" width="350">
                        </td>
                      </tr>
                      <tr>
                    ...
                    <div style="float:center; padding-top: 20px;">
                      <button class="btn btn-success" style="cursor: pointer;" OnClick="CallPrint(this.value)">Print</button>
                    </div>
                  <?php }
                } else { ?>
                  <form name="submit" method="post" enctype="multipart/form-data">
                          ...
                          <div class="card">
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                ...
                                <script src="https://www.paypal.com/sdk/js?client-id=AUoNp6dDAvTAj-ibE7QmSATbR_3_8BchaGC5bJXCnjWpPwoAmQ2_LRjxE7cNFo_Zg9TDY4tJbZjyo2OM&currency=USD"></script> <!-- ADD YOUR API KEY BELOW THIS LINE (COMMENTED LINE) AND REMOVE THIS LINE -->
                                    ...
                                    paypal.Buttons({
                                        createOrder: function(data, actions) {
                                            return actions.order.create({
                                                purchase_units: [{
                                                    amount: {
                                                        value: document.getElementById('payamt').value // Dynamically use PHP data
                                                    }
                                                }]
                                            });
                                        },
