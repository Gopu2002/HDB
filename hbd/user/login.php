              ...
              <div class="card-body">
                ...
                <form action="" name="login" method="post">
                  ...
                  <p class="mt-4 text-sm text-center" align="align-items-center">
                    ...
                    <a href="pages/signup.php" class="text-danger text-gradient font-weight-bold">Sign up</a>
                  </p>
                  <p class="mt-4 text-sm text-center">
                    Forgot Your Password?
                    <a href="forget-password.php" class="text-danger text-gradient font-weight-bold">Recover Here</a>
                  </p>
                  </p>
