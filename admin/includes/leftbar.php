 <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content">
     ...
     <li class=" nav-item"><a href="#"><i class="la la-book"></i><span class="menu-title" data-i18n="nav.footers.main">Course</span></a>
...
<li class=" nav-item"><a href="#"><i class="la la-bell"></i><span class="menu-title" data-i18n="nav.footers.main">Public Notice</span></a>
          <ul class="menu-content">
...
<li class=" nav-item"><a href="#"><i class="la la-question-circle"></i><span class="menu-title" data-i18n="nav.footers.main">Inquiry</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="unreadenq.php" data-i18n="nav.footers.footer_light">Unread Inquiry</a>
            </li>
            <li><a class="menu-item" href="readenq.php" data-i18n="nav.footers.footer_dark">Read Inquiry</a>
            </li>
