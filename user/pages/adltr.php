...
if ( $row['AdminStatus'] == '1') {
              ...
              <h3>LETTER OF ADMISSION TO, <?php echo $row['Signature']?></h3>
                      ...
                      <p>
                        ...
                        YOU ARE EXPECTED TO PAY THE ACCEPTANCE FEE WITHIN 15 DAYS . <br>
                        
                        PLEASE NOTE THAT THE ACCEPTANCE FEE IS NON-REFUNDABLE AND DOES NOT GUARANTEE YOUR ADMISSION.<br> 

                        NOTE THAT UNDER NO CIRCUMSTANCE WOULD THE DATE FOR THE PAYMENT OF ACCEPTANCE FEE BE EXTENDED.
           
                <b>REGARDING FEE PAY</b>
            <li>1 - PAY YOUR ACCEPTANCE FEE WITH AN APPROPRITE METHOD.</li>
            <li>2 - PRINT YOUR ACCEPTANCE FEE RECEIPT.</li>
            <li>3 - KEEP YOUR RECEIPT AND CLEARANCE SCHEDULE FOR REGISTRATION.</li>
           
            <h3><b>THE FOLLOWING DOCUMENTS ARE REQUIRED FOR REGISTRATION:</b></h3>
            <small>BRING ORIGENAL AND XEROX ALSO</small>
           
            <li>1.ID PROOF </li>
            <li>2.4 PASSPORT SIZE PHOTOS</li>
            <li>3.APPLICATION SLIP.</li>
            <li>4.ADMISSION LETTER.</li>
            <li>5.ACCEPTANCE FEE RECEIPT.</li>
            <li>6.10TH MARKSHEET & PASSING CERTIFFECATE</li>
            <li>10.112TH MARKSHEET & PASSING CERTIFFECATE</li>
            <li>11.PG MARKSHEETS <small>[ALL SEMESTERS]</small>IF APPLAY FOR MASTERS</li>
            <li>12.RECEIPT FOR PAYMENT MADE FOR CHANGE OF COURSE/INSTITUTION. (IF APPLICABLE)</li>
