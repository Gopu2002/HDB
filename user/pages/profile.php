    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="" target="_blank">
        <span class="ms-1 font-weight-bold text-white">
          <span face="Comic sans MS" size="4">Hello Dreamy Birds</span>
        </span>
      </a>
    </div>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0"> <i class="material-icons-round opacity-10">person</i>
            | Profile</h6>
        </nav>
        ...
        <section class="formatter" id="formatter">
          ...
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-info shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">User Basic Details</h6>
            </div>
            <div class="card">
              <div class="card-content">
                ...
                <?php } ?>
                <small><b>NOTE : </b>You Can Not Change EmailID & Contact Number..</small>
